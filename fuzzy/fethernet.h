...
void forKinematic(){
    ...
    double m1= 0;//((roda1.en1-roda1.enprev1)*kRoda/PPR)/4;
    double m2= 0;//((roda2.en2-roda2.enprev2)*kRoda/PPR)/4;
    double m3= 0;//((roda3.en3-roda3.enprev3)*kRoda/PPR)/4;
    double m4= 0;//((roda4.en4-roda4.enprev4)*kRoda/PPR)/4;
