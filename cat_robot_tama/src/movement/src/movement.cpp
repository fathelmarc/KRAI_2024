...
int main(int argc, char** argv){
    ...
    while(ros::ok()){
        ...
        if (caseBot == 0 && joy.axisStates[LeftHatX] > 1 && joy.axisStates[LeftHatX] < 32769 ||
            ...
            motion.move_to(tanam1[0], tanam1[1],0);
            caseBot = 0;
        }else if(caseBot == 3){ // tanam 2
            caseBot = 0;
        }else if(caseBot == 4){ // ambil 2
            motion.move_to(ambil2[0] , ambil2[1] + 5,0);
            caseBot = 0;
        }else if(caseBot == 5){
            motion.move_to(tanam3[0], tanam3[1], 0);
            caseBot = 0;
        }else if(caseBot == 6){
            caseBot = 0;
        }else if(caseBot == 7){
            motion.move_to(ambil3[0], ambil3[1] + 5,0);
            caseBot = 0;
        }else if(caseBot == 8){
            motion.move_to(tanam5[0], tanam5[1],0);
            caseBot = 0;
        }else if(caseBot == 9){
            motion.move_to(tanam6[0], tanam6[1],0);
            caseBot = 0;
        }
