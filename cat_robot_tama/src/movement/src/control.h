...
void addData(int kasus, float x, float y, float h) {
    ...
    if (kasus > 0 && kasus <= 9 && lantai2 == 0) {
        if(kasus == 1){
            filename << "/home/m/catR1/src/movement/src/data_cel/ambil1.txt";
        }else if(kasus == 2){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam1.txt";
        }else if(kasus == 3){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam2.txt";
        }
        
        else if(kasus == 4){
            filename << "/home/m/catR1/src/movement/src/data_cel/ambil2.txt";
        }else if(kasus == 5){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam3.txt";
        }else if(kasus == 6){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam4.txt";
        }
        
        else if(kasus == 7){
            filename << "/home/m/catR1/src/movement/src/data_cel/ambil3.txt";
        }else if(kasus == 8){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam5.txt";
        }else if(kasus == 9){
            filename << "/home/m/catR1/src/movement/src/data_cel/tanam6.txt";
        }
