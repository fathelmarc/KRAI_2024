...
//     static auto lastReceiveTime1 = chrono::steady_clock::now();
//     static auto lastReceiveTime2 = chrono::steady_clock::now();
//     static auto lastReceiveTime3 = chrono::steady_clock::now();
//     static auto lastReceiveTime4 = chrono::steady_clock::now();
//     chrono::seconds timeoutDuration(5); // Set timeout duration to 5 seconds

//     if (roda1.terimaData(sockfd)) lastReceiveTime1 = chrono::steady_clock::now();
//     if (roda2.terimaData(sockfd)) lastReceiveTime2 = chrono::steady_clock::now();
//     if (roda3.terimaData(sockfd)) lastReceiveTime3 = chrono::steady_clock::now();
//     if (roda4.terimaData(sockfd)) lastReceiveTime4 = chrono::steady_clock::now();

//     auto now = chrono::steady_clock::now();
//     if (now - lastReceiveTime1 > timeoutDuration) {
//         cout << "Client 192.168.0.67 timed out" << endl;
//     }
//     if (now - lastReceiveTime2 > timeoutDuration) {
//         cout << "Client 192.168.0.66 timed out" << endl;
//     }
//     if (now - lastReceiveTime3 > timeoutDuration) {
//         cout << "Client 192.168.0.69 timed out" << endl;
//     }
//     if (now - lastReceiveTime4 > timeoutDuration) {
//         cout << "Client 192.168.0.68 timed out" << endl;
//     }
// }
void forKinematic(){
    // checkEthernetStatus();
